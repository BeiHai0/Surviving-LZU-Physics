...
腔体能量密度 $$\rho_\lambda$$ 的极大值点 $$\lambda_m$$ 与温度成反比
...
一次仅让一个电子通过双缝，随着电子的数目增多，在屏上逐渐形成了具有波动性的干涉图样。若在双缝后用仪器探测电子的轨迹，干涉图样消失。
...
$$
(\hat{\vec{\sigma}}\cdot\vec{A})(\hat{\vec{\sigma}}\cdot\vec{B})
...
&=\hbar\omega(\frac{29}{20}-\frac{\sqrt{3}}{5}\cos 2\omega t)
\end{aligned}
$$
