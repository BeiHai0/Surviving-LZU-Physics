...
一个单原子链，相当于弹性波的低通滤波器，它的本征频率必须限制在 $0\leqslant \omega\leqslant \omega_{\max} $ 范围之内，不存在 $\omega>\omega_{\max} $ 的本征频率，这样的波不能在系统中传播。
...
由质量 $m_1,m_2(m_1>m_2) $ 的原子构成，假设系统有 $N $ 个元胞，每个元胞中有不同的原子，晶格常量为 $a $，
