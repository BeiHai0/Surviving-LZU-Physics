...
&=\delta\left(\varepsilon_k^2 - k_0^2 \right) \\
\end{aligned}
$$
...
把 $\delta\left(\varepsilon_k^2 - k_0^2 \right) $ 看成关于 $k_0 $ 的单变量复合函数 $\delta(\varphi(k_0)) $，内层函数 $\varphi(k_0)=\varepsilon_k^2 - k_0^2 $ 有两个单根 $\pm \varepsilon_k $，其导函数 $\varphi'(k_0)=-2k_0 $ 则

$$
\begin{aligned}
\delta\left(k^2+m^2 \right)
&=\delta\left(\varepsilon_k^2 - k_0^2 \right) \\
&=\frac{1 }{\left|-2 \left(-\varepsilon_k \right) \right| } \delta(k_0+\varepsilon_k) + \frac{1 }{\left|-2\varepsilon_k \right| } \delta(k_0-\varepsilon_k) \\
&=\frac{1 }{2\varepsilon_k } \left[\delta(k_0+\varepsilon_k) + \delta(k_0-\varepsilon_k) \right]
\end{aligned}
$$
...
$$
\phi^{(+)}(x)
\equiv \left(\frac{1 }{2\pi }  \right)^{3/2} \int \mathrm{e}^{\mathrm{i} k x} \delta\left(k^2+m^2 \right)\theta_-(k_0) \phi(k) \mathrm{d}k,\quad k_0<0
$$
...
\begin{aligned}
\frac{\partial \hat{\phi}^{(+)}(x) }{\partial t } 
&=\left(\frac{1 }{2\pi }  \right)^{3/2} \int \mathrm{i} \varepsilon_k \mathrm{e}^{-\mathrm{i} k x} \delta\left(k^2+m^2 \right)\phi^{(+)}(k) \mathrm{d}k \\
\end{aligned}
$$
...
$$
\left[\hat{H} , \hat{\phi}^{(+)}(k) \right] = \varepsilon_k \hat{\phi}^{(+)}(k)
$$
...
&=\left(\varepsilon_k \hat{\phi}^{(+)}(k) + \hat{\phi}^{(+)}(k) \hat{H} \right) \Psi_E \\
&=\left(E + \varepsilon_k \right) \hat{\phi}^{(+)}(k) \Psi_E
\end{aligned}
$$
