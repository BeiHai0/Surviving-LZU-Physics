...
$$
\dot{\hat{U}}_\alpha\left(x^1 \right)\dot{\hat{U}}_\beta\left(x^2 \right)
=\left(T-N \right)\left[\hat{U}_\alpha\left(x^1 \right)\hat{U}_\beta \right]
