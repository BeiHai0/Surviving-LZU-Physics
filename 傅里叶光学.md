...
$$L_1 $$ 是准直透镜，$$L_2,L_3 $$ 为傅里叶变换透镜，焦距均为 $$f $$；$$P_1,P_2,P_3 $$ 分别是物面、频谱面和像面；$$P_3 $$ 采用反射坐标系。
...
其中，$$\displaystyle{f_x=\frac{x_2}{\lambda f},f_y=\frac{y_2}{\lambda f} }$$

位相滤波器，只要用一块玻璃基片，其上相对于焦平面中心位置镀上一定厚度的膜层，使零频成分通过它后，其位相相对于衍射光相位延迟 $$\pi/2 $$ 或 $$3\pi/2 $$
