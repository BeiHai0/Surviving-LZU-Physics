...
$$
U_f(x_f,y_f)
=\frac{A}{\mathrm{j}\lambda f}\exp\bigg[ \mathrm{j} \frac{k}{2f}(1-\frac{d_0}{f})(x_f^2+y_f^2) \bigg] \times \mathscr{F}\{t(x_0,y_0)P(x_0+\frac{d_0}{f}x_f,y_0+\frac{d_0}{f}y_f) \}(f_x=\frac{x_f}{\lambda f},f_y=\frac{y_f}{\lambda f})
$$
