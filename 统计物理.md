...
在体积 $V$ 内，在 $\varepsilon$ 到 $\varepsilon+\mathrm{d}\varepsilon$ 的能量范围内，分子可能的围观状态数为：
...
$$
\frac{2\pi}{h^3}(2m)^{\frac{3}{2}}\int_{0}^{+\infty} \frac{\varepsilon^\frac{1}{2}\mathrm{d}\varepsilon}{e^{\frac{\varepsilon-\mu}{kT}}-1}
=n
$$
...
### $T=0~\mathrm{K}$ 时，金属中理想电子气体的化学势 $\mu(0)$，内能 $U(0)$，压强 $p(0)$
