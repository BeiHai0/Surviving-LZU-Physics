...
# 
T_Bzx = overlap * (1j * cor_alpha_1_alpha_2_dag - cor_alpha_1_c_i_A_c_j_B_alpha_2_dag)

manager.save_data('T_Bzx', T_Bzx, N1, N2, bc1, bc2, **params)
print('done!')
