...
U0_dagger = U0.T.conj()
# 
eigvals_positive_1 = manager.load_data('eigvals_positive_vison_pair_z', N1, N2, bc1, bc2, **params)
W_1 = manager.load_data('W_vison_pair_z', N1, N2, bc1, bc2, **params)
V_1 = manager.load_data('V_vison_pair_z', N1, N2, bc1, bc2, **params)
U_1 = np.block([[W_1, V_1.conj()], [V_1, W_1.conj()]])

eigvals_positive_2 = manager.load_data('eigvals_positive_vison_pair_x', N1, N2, bc1, bc2, **params)
W_2 = manager.load_data('W_vison_pair_x', N1, N2, bc1, bc2, **params)
V_2 = manager.load_data('V_vison_pair_x', N1, N2, bc1, bc2, **params)
...
# 
T_Azx = overlap * (1j * cor_alpha_1_alpha_2_dag - cor_alpha_1_c_i_A_c_j_B_alpha_2_dag)

manager.save_data('T_Azx', T_Azx, N1, N2, bc1, bc2, **params)
print('done!')
