...
$$
\begin{aligned}
\Braket{b'_1 b'_2 \cdots b'_n | \sum_{i} g_i^{(1)} | b_1 b_2 \cdots b_n }
=&\frac{1 }{\left(n! \right)^2 } \sum_{\sigma' \in S_n} \sum_{\sigma \in S_n} \varepsilon^{p(\sigma') + p(\sigma)} P(\sigma') P(\sigma) \bigg\{ \\
&
\bigg\}
\end{aligned}
$$
