...
&=\frac{1}{2}+\frac{1}{2}\mathrm{sinc}(\frac{3}{2})\bigg[ \delta(f-\frac{3}{2a})+\delta(f+\frac{3}{2a}) \bigg] 
\end{aligned}
$$
...
\begin{aligned}
g(x)
&=\frac{1}{2}\delta(x)+\frac{1}{2}\mathrm{sinc}(\frac{3}{2})\cos(2\pi \cdot \frac{3}{2a}\cdot x) \\
&=              
\end{aligned}
$$
